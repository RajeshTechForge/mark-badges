...
> [!NOTE]
> This repository is an extended work built upon the foundation established by [tandpfun/skill-icons](https://github.com/tandpfun/skill-icons), originally created by [Thijs Simonian](https://github.com/tandpfun). Full credit for the original work belongs to them.
